...
class _MultitaskQExponentialLikelihoodBase(_QExponentialLikelihoodBase):
    ...
    def marginal(
        ...
        :obj:`~gpytorch.distributions.MultivariateQExponential` or
        :obj:`~gpytorch.distributions.MultitaskMultivariateQExponential`.  Otherwise,
        ...
        :class:`gpytorch.likelihoods.QExponentialLikelihood` that we extend.
...
class MultitaskQExponentialLikelihood(_MultitaskQExponentialLikelihoodBase):
    r"""
    A convenient extension of the :class:`~gpytorch.likelihoods.QExponentialLikelihood` to the multitask setting that allows
    ...
    .. note::
        MultittaskQExponentialLikelihood has an analytic marginal distribution.
...
class MultitaskFixedNoiseQExponentialLikelihood(_MultitaskQExponentialLikelihoodBase):
    r"""
    A convenient extension of the :class:`~gpytorch.likelihoods.FixedNoiseQExponentialLikelihood` to the multitask setting
