...
try:
    ...
    class Likelihood(_Likelihood):
        ...
        def marginal(self, function_dist: Union[MultivariateNormal, MultivariateQExponential], *args: Any, **kwargs: Any) -> _Distribution:
            ...
            or :obj:`~gpytorch.distributions.MultivariateQExponential` specified by the mean and
        ...
        def __call__(self, input: Union[Tensor, MultivariateNormal, MultivariateQExponential], *args: Any, **kwargs: Any) -> _Distribution:
            ...
            .. code-block:: python
                ...
                f = torch.randn(20)
                likelihood = gpytorch.likelihoods.GaussianLikelihood() or gpytorch.likelihoods.QExponentialLikelihood()
                ...
                or >>> gpytorch.distributions.QExponential, torch.Size([20]), torch.Size([])

            2. If likelihood is called with a :class:`~gpytorch.distributions.MultivariateNormal` 
               or :class:`~gpytorch.distributions.MultivariateQExponential` object,
               ...
               :class:`~gpytorch.likelihoods.GaussianLikelihood` and 
               :class:`~gpytorch.likelihoods.QExponentialLikelihood` objects, the marginal distribution
            ...
            .. code-block:: python
                ...
                f = gpytorch.distributions.MultivariateNormal(mean, covar) or 
                power = torch.tensor(1.0)
                f = gpytorch.distributions.MultivariateQExponential(mean, covar, power)
                ...
                or gpytorch.likelihoods.QExponentialLikelihood()
                marginal = analytic_marginal_likeihood(f)
                print(type(marginal), marginal.batch_shape, marginal.event_shape)
                # >>> gpytorch.distributions.MultivariateNormal, torch.Size([]), torch.Size([20]) or
                # >>> gpytorch.distributions.MultivariateQExponential, torch.Size([]), torch.Size([20])
...
class _OneDimensionalLikelihood(Likelihood, ABC):
    r"""
    A specific case of :obj:`~gpytorch.likelihoods.Likelihood` when the GP (QEP) represents a one-dimensional
