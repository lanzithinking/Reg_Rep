...
class ExactMarginalLogLikelihood(MarginalLogLikelihood):
    ...
    .. note::
        ...
        (:obj:`~gpytorch.likelihoods.QExponentialLikelihood`) and a :obj:`~gpytorch.models.ExactGP` (:obj:`~gpytorch.models.ExactQEP`). 
        It also cannot be used in conjunction with stochastic optimization.

    :param ~gpytorch.likelihoods.GaussianLikelihood (~gpytorch.likelihoods.QExponentialLikelihood) likelihood: The Gaussian (Q-Exponential) likelihood for the model
    :param ~gpytorch.models.ExactGP (~gpytorch.models.ExactQEP) model: The exact GP (QEP) model

    Example:
        >>> # model is a gpytorch.models.ExactGP or gpytorch.models.ExactQEP
    ...
    def forward(self, function_dist, target, *params):
        ...
        :param ~gpytorch.distributions.MultivariateNormal or ~gpytorch.distributions.MultivariateQExponential function_dist: :math:`p(\mathbf f)`
            the outputs of the latent function (the :obj:`gpytorch.models.ExactGP` or :obj:`gpytorch.models.ExactQEP`)
