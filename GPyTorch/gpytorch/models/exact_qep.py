...
class ExactQEP(QEP):
    ...
    :param ~gpytorch.likelihoods.QExponentialLikelihood likelihood: The Q-Exponential likelihood that defines
    ...
    The result must be a :obj:`~gpytorch.distributions.MultivariateQExponential`.

    Calling this model will return the posterior of the latent Q-Exponential process when conditioned
    on the training data. The output will be a :obj:`~gpytorch.distributions.MultivariateQExponential`.

    Example:
        >>> class MyQEP(gpytorch.models.ExactQEP):
        ...
        >>>         return gpytorch.distributions.MultivariateQExponential(mean, covar, self.likelihood.power)
        >>>
        >>> # train_x = ...; train_y = ...
        >>> likelihood = gpytorch.likelihoods.QExponentialLikelihood(power=torch.tensor(1.0))
    ...
    def _apply(self, fn):
        ...
        return super(ExactQEP, self)._apply(fn)
    ...
    def get_fantasy_model(self, inputs, targets, **kwargs):
        ...
        :rtype: ~gpytorch.models.ExactEQP
        """
        ...
        full_output = super(ExactQEP, self).__call__(*full_inputs, **kwargs)
