...
sys.path.insert(0,'../..')
import gpytorch
from gpytorch.likelihoods import QExponentialLikelihood, MultitaskQExponentialLikelihood
...
class LMCModel(gpytorch.models.ApproximateQEP):
    def __init__(self):
    ...
    def forward(self, x):
        ...
        return gpytorch.distributions.MultivariateQExponential(mean_x, covar_x, power=self.power)
