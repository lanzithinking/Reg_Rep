...
loss_list = []
if os.path.exists(os.path.join('./results', 'robot_betavae_checkpoint.dat')):
    state_dict = torch.load(os.path.join('./results','robot_betavae_checkpoint.dat'), map_location=device)['model']
else:
    # set device
    ...
    torch.save({'model': state_dict}, os.path.join('./results','robot_betavae_checkpoint.dat'))
...
# plt.show()
os.makedirs('./results', exist_ok=True)
plt.savefig(os.path.join('./results','robot_betavae.png'),bbox_inches='tight')
...
plt.tick_params(axis='both', which='major', labelsize=14)
plt.savefig(os.path.join('./results','robot_latent_betavae.png'),bbox_inches='tight')
...
plt.tick_params(axis='both', which='major', labelsize=14)
plt.savefig(os.path.join('./results','robot_latdim_betavae.png'),bbox_inches='tight')
...
plt.xlabel('Latent dim 1', fontsize=20)
plt.ylabel('Latent dim 2', fontsize=20)
plt.savefig(os.path.join('./results','robot_betavae_latent.png'),bbox_inches='tight')